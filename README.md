Извините за недоразумение! Я ошибся, не добавив информацию о скрипте **Spawner**. Вот исправленное описание с добавлением информации о спавнере, который генерирует фрукты в игре:
